...
def getBlobs(a,b,c,d):
         ...
         blank.save("p" + str(d) + ".jpg")
         img = cv2.imread("p" + str(d) + ".jpg")
         ...
         cv2.imwrite("crop" + str(d) + ".jpg", crop_img)  

         blob_dog2 = blobDetector("crop" + str(d) + ".jpg",False)
         imz = Image.open("crop" + str(d) + ".jpg")
         xb,yb = imz.size
         nbl = normalizeCirc(xb,yb,x0,y0,blob_dog2)
